...
const segmentationThreshold = 0.88;
const backgrounds = ["collegegreen"];
const backgroundImagesPath =  'images/';
const snapSound = new Audio('sound/snap.wav');
...
$("#webcam-switch").change(function () {
    if(this.checked){
		...
		// ACTIVATE BG
		var el =  document.querySelector('a-scene').components.screenshot.getCanvas('perspective');
		var bg = document.getElementById('background-container');
		bg.style.backgroundImage ="url('"+el.toDataURL('image/jpeg', 1.0)+"')";
